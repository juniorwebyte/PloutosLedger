      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex gap-2">
            <button onClick={refresh} className="inline-flex items-center gap-2 px-4 py-2 border text-gray-700 rounded-lg text-sm font-medium">Atualizar</button>
            <button onClick={add} className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-indigo-600 to-blue-600 text-white rounded-lg text-sm font-medium"><Plus className="w-4 h-4"/> Usuário</button>
          </div>
          </div>
        ...
        <div className="mb-4 flex gap-2">
          {(['usuarios','organizacoes','planos','assinaturas','caderno'] as const).map(t => (
            ...
            }} className={`px-3 py-1.5 rounded border flex items-center gap-2 ${activeTab===t?'bg-white':'bg-gray-100'}`}>
