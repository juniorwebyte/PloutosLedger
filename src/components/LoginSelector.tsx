    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-900 via-teal-900 to-cyan-900 flex items-center justify-center p-4">
      <div className="max-w-6xl w-full">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-emerald-200 mb-2 animate-fade-in" style={{animationDelay: '200ms'}}>
            Sistema de Gestão Financeira
          </p>
          <p className="text-lg text-emerald-300 animate-fade-in" style={{animationDelay: '400ms'}}>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {/* Cliente/Loja */}
          <div
            className={`group relative bg-white/10 backdrop-blur-lg rounded-3xl p-8 border-2 transition-all duration-500 cursor-pointer transform hover:scale-105 hover:-translate-y-2 ${
              hoveredCard === 'client'
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-emerald-200 text-center mb-6 leading-relaxed">
