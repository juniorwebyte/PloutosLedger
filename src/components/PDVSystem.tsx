        ...
        <div className="bg-gray-50 rounded-xl p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                <span className="text-gray-700">Envio por email</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-gray-50 rounded-xl p-6">
            ...
            <div className="space-y-2 text-sm text-gray-600">
              ...
              <p><strong>Email:</strong> contato@samsung.com.br</p>
            </div>
            <div className="mt-4 flex space-x-2">
              <button className="flex-1 px-3 py-2 bg-blue-100 text-blue-600 rounded-lg hover:bg-blue-200 transition-colors text-sm">
                Editar
          ...
          <div className="bg-gray-50 rounded-xl p-6">
            ...
            <div className="space-y-2 text-sm text-gray-600">
              ...
              <p><strong>Email:</strong> contato@dell.com.br</p>
            </div>
            <div className="mt-4 flex space-x-2">
              <button className="flex-1 px-3 py-2 bg-blue-100 text-blue-600 rounded-lg hover:bg-blue-200 transition-colors text-sm">
                Editar
          ...
          <div className="bg-gray-50 rounded-xl p-6">
            ...
            <div className="space-y-2 text-sm text-gray-600">
              ...
              <p><strong>Email:</strong> contato@apple.com.br</p>
            </div>
            <div className="mt-4 flex space-x-2">
              <button className="flex-1 px-3 py-2 bg-blue-100 text-blue-600 rounded-lg hover:bg-blue-200 transition-colors text-sm">
                Editar
